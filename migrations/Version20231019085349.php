 ...
 */
final class Version20231019085349 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sweets CHANGE description description VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sweets CHANGE description description VARCHAR(600) NOT NULL');
